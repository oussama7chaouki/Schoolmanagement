...
public void showrecord(){
    ...
    ResultSetMetaData rsmd=rs.getMetaData();
     ...
     String id,cne,stdname,stdphone,stdmail,classe,stdcity;
     while(rs.next()){
         id=rs.getString(1);
         cne=rs.getString(2);
         stdname=rs.getString(3);
         stdphone=rs.getString(4);
         stdmail=rs.getString(5);
         classe=rs.getString(6);
         stdcity=rs.getString(7);
         String[] row={id,cne,stdname,stdphone,stdmail,classe,stdcity};  
     model.addRow(row);
     }
